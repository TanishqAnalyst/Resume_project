...
select a.segment as segment, 
	...
	order by b.product_count_2021 - a.product_count_2020 desc;
...
select quarter(date) as Sales_quarter, 
...
select channel, 
total_sales/(select sum(b.sold_quantity*a.gross_price) as gross_sales from fact_gross_price a
right join 
...
From (select a.division, b.sold_quantity, b.product_code,
